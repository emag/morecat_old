...
INSERT INTO entries (title, content, author_id, created_at, state, format) VALUES ('title2', 'content2', 1, now(), 'PRIVATE', 'HTML');
INSERT INTO tags (entry_id, value) VALUES (2, 'tag1');

INSERT INTO entries (title, content, author_id, created_at, state, format) VALUES ('title3', 'content3', 1, now(), 'DRAFT', 'MARKDOWN');
