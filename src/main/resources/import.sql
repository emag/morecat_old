...
INSERT INTO entries (title, content, permalink, author_id, created_date, created_time, state, format) VALUES ('title1', 'content1', 'permalink1', 1, now(), now(), 'PUBLIC', 'MARKDOWN');

INSERT INTO entries (title, content, permalink, author_id, created_date, created_time, state, format) VALUES ('title2', 'content2', 'permalink2', 1, now(), now(), 'DRAFT', 'HTML');
INSERT INTO tags (entry_id, value) VALUES (2, 'tag1');

INSERT INTO entries (title, content, permalink, author_id, created_date, created_time, state, format) VALUES ('title3', 'content3', 'permalink3', 2, now(), now(), 'DRAFT', 'MARKDOWN');
